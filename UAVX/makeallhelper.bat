...
%LEXE% %LCMD% %F% /u_CRUNTIME /z__MPLAB_BUILD=1 /W /o UAVX%L%-V2.1073gke-18F2620-40%I%%G%%C%%D%%T%.hex >> log.lst 


if %ERRORLEVEL% == 1 goto FAILED

echo compiled - UAVX%L%-V2.1073gke-18F2620-40%I%%G%%C%%D%%T%.hex
echo compiled - UAVX%L%-V2.1073gke-18F2620-40%I%%G%%C%%D%%T%.hex >> gen.lst
call makeclean.bat
goto FINISH

:FAILED
echo failed - UAVX%L%-V2.1073gke-%E%18F2620-40%I%%G%%C%%D%%T%.hex
echo failed - UAVX%L%-V2.1073gke-%E%18F2620-40%I%%G%%C%%D%%T%.hex >> gen.lst
